function init() {
  ...
  function buildCharts(sample) {
    ...
    d3.json("samples.json").then((data) => {
      ...
      // Deliverable 3
      // 1. Create a variable that filters metadata array
      var metadata = data.metadata;
      ...
      var barLayout = {
        ...
        annotations: [{
          ...
          y: -0.25,
          yanchor: 'center',
          text: 'This chart displays the top 10 bacterial species found in your belly button',
          showarrow: false
        }]
      };
      ...
      var gaugeData = {
        ...
        gauge: {
          ...
          steps: [
            ...
            {range: [4,6], color:"#e7ee00"},
            {range: [6,8], color:"#8fcd00"},
            {range: [8,10], color:"#38761d"}
          ]
        }
      };
